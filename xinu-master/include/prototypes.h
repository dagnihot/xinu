...
extern future* future_alloc(int);

/* in file future_free.c */
extern syscall future_free(future*);

/* in file future_get.c */
extern syscall future_exclusive_get(future*, int*);
extern syscall future_get(future*, int*);

/* in file future_set.c */
extern syscall future_exclusive_set(future*, int*);
extern syscall future_set(future*, int*);

/* in file future_test.c */
